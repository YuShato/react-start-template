...
export const getBeautifulNumber = (value: number | string, separator = ' ') =>
...
export const getNumberedArray = (arr: number[]) => arr.map((value, number: number) => ({ value, number }));
...
export const toStringArray = (arr: MyObject[]): string[] => {
...
export const transformCustomers = (customers: ICustomer[]) => {
  return customers.reduce(
    (acc: { [id: number]: { name: string; age: number; isSubscribed: boolean } }, customer: ICustomer) => {
